...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $files = $_FILES['files']; // Para manejar los archivos cargados
...
<body class="bg-gray-100 flex justify-center items-center min-h-screen">
    <div class="w-full max-w-lg bg-white p-8 rounded-lg shadow-lg">
        ...
        <form action="" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <!-- Campo de carga de múltiples archivos -->
            <div>
                <label for="files" class="block text-sm font-medium text-gray-700">Adjuntar archivos:</label>
                <input type="file" id="files" name="files[]" accept="image/*,application/pdf,.docx,.xlsx,.txt" multiple
                    class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
            </div>
